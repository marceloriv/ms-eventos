    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Modificación de stock (consumido por ms-carrito internamente)
                        .requestMatchers(HttpMethod.PUT, "/api/v0/Eventos/actualizarStock/**").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/v0/Eventos/restaurarStock/**").permitAll()
